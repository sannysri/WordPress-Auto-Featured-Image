...
class WPAFI_Review_Notice {
	...
	/**
	 * Option name for storing plugin install time.
	 *
	 * @var string
	 */
	...
	/**
	 * Option name for storing dismissed status.
	 *
	 * @var string
	 */
	...
	/**
	 * Option name for storing remind later timestamp.
	 *
	 * @var string
	 */
	...
	/**
	 * Number of days to wait before showing notice.
	 *
	 * @var int
	 */
	...
	/**
	 * Number of days to wait after "remind later" is clicked.
	 *
	 * @var int
	 */
	...
	/**
	 * Check if the notice should be shown based on timing.
	 *
	...
	/**
	 * Display the review notice HTML.
	 *
	 * @return void
	 */
	...
	/**
	 * Handle notice action requests (dismiss or remind later).
	 *
	 * @return void
	 */
	...
	/**
	 * Output inline styles for the review notice.
	 *
	 * @return void
	 */
